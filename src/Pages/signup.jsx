  ...
  return (
    <div className='mt-20 item-center justify-center border-0 rounded-md'>
        <div className='flex flex-col items-center justify-center h-screen'>
            ...
            <button type='submit' className='w-full bg-cyan-500 hover:bg-gradient-to-r from-purple-800 to-cyan-500 text-white font-bold py-2 px-4 rounded-md'>Sign Up</button>
            </form>
        </div>
    </div>
  )
